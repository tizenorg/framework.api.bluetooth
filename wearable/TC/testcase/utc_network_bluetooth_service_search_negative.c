...
void adapter_state_changed_cb_for_service_search_n(int result, bt_adapter_state_e adapter_state, void* user_data);
...
static void utc_network_bluetooth_service_search_set_cb_n(void)
{
	...
	dts_check_eq("bt_device_set_service_searched_cb", ret, BT_ERROR_INVALID_PARAMETER, 
...
static void utc_network_bluetooth_service_search_unset_cb_n(void)
{
	...
	{
		dts_fail("bt_device_unset_service_searched_cb", "bt_deinitialize() failed.");
	}	

	ret = bt_device_unset_service_searched_cb();
	dts_check_eq("bt_device_unset_service_searched_cb", ret, BT_ERROR_NOT_INITIALIZED, 
...
static void utc_network_bluetooth_service_search_n(void)
{
	...
	dts_check_eq("bt_device_start_service_search", ret, BT_ERROR_INVALID_PARAMETER, 
