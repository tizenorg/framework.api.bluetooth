...
void adapter_state_changed_cb_for_adapter_p(int result, bt_adapter_state_e adapter_state, void* user_data);
void adapter_state_changed_cb_for_adapter_p(int result, bt_adapter_state_e adapter_state, void* user_data);
void adapter_name_changed_cb_for_adapter_p(char* device_name, void* user_data);
void adapter_visibility_mode_changed_cb_for_adpater_p(int result, bt_adapter_visibility_mode_e visibility_mode, void* user_data);
void device_discovery_state_changed_cb_for_adapter_p(int result, \
		bt_adapter_device_discovery_state_e discovery_state, bt_device_info_s *device_info, void* user_data);
...
void adapter_name_changed_cb_for_adapter_p(char *device_name, void* user_data)
{
	tet_printf("bt_adapter_name_changed_cb_for_adapter_p was called: %s", (char *)device_name);
...
static void utc_network_bluetooth_initialize_p(void)
{
	...
	dts_check_eq("bt_initialize", ret, BT_ERROR_NONE, "bt_initialize() failed.");
}
...
static void utc_network_bluetooth_deinitialize_p(void)
{
	...
	dts_check_eq("bt_deinitialize", ret, BT_ERROR_NONE, "bt_deinitialize() failed.");
}
...
static void utc_network_bluetooth_adapter_set_state_changed_cb_p(void)
{
	...
	dts_check_eq("bt_adapter_set_state_changed_cb", ret, BT_ERROR_NONE, "bt_adapter_set_state_changed_cb failed.");
}
...
static void utc_network_bluetooth_adapter_set_visibility_mode_changed_cb_p(void)
{
	...
	dts_check_eq("bt_adapter_set_visibility_mode_changed_cb", ret, BT_ERROR_NONE, 
...
static void utc_network_bluetooth_adapter_enable_p(void)
{
	...
	{
		dts_fail("bt_adapter_enable", "bt_adapter_set_state_changed_cb() failed.");
	}                
	...
	dts_check_eq("bt_adapter_enable", callback_result, true, "BT was not enabled.");
}
...
static void utc_network_bluetooth_adapter_get_state_p(void)
{
	...
	{
		dts_pass("bt_adapter_get_state", "bt_adapter_get_state() succeeded.");                
	}
	else
	{
		dts_fail("bt_adapter_get_state", "bt_adapter_get_state() failed.");                
	}
}
...
static void utc_network_bluetooth_adapter_get_visibility_p(void)
{
	...
	int ret = bt_adapter_get_visibility(&mode);
...
static void utc_network_bluetooth_adapter_set_name_p(void)
{
	...
	{
		dts_fail("bt_adapter_set_name", "bt_adapter_set_name_changed_cb() failed.");
	}
	...
	if( bt_adapter_set_name(adapter_name) == BT_ERROR_NONE )
	{
		...
		dts_check_eq("bt_adapter_set_name", callback_result, true, "The local adapter name was not set.");
	}
	else
	{
...
static void utc_network_bluetooth_adapter_set_visibility_p(void)
{
	...
	if( bt_adapter_set_visibility_mode_changed_cb(adapter_visibility_mode_changed_cb_for_adpater_p, 
		"set_visibility") != BT_ERROR_NONE )
	{
		dts_fail("bt_adapter_set_visibility", "bt_adapter_set_visibility_mode_changed_cb() failed.");
	}
	...
	{                                
		...
		dts_check_eq("bt_adapter_set_visibility", callback_result, true, "The visibility of BT was not set.");
	}
	else
	{
		dts_fail("bt_adapter_set_visibility", "bt_adapter_set_visibility() failed");
	} 
}
...
static void utc_network_bluetooth_adapter_disable_p(void)
{
	...
	{
		dts_fail("bt_adapter_disable", "bt_adapter_set_state_changed_cb() failed.");
	}                
	...
	{                                
		...
		g_source_remove(timeout_id);
		bt_adapter_unset_state_changed_cb();
		dts_check_eq("bt_adapter_disable", callback_result, true, "BT was not disabled");
	}
	else
	{
...
static void utc_network_bluetooth_adapter_unset_visibility_mode_changed_cb_p(void)
{
	...
	dts_check_eq("bt_adapter_unset_visibility_mode_changed_cb", ret, BT_ERROR_NONE, \
