...
void adapter_state_changed_cb_for_socket_p(int result, bt_adapter_state_e adapter_state, void* user_data);
void device_discovery_state_changed_cb_for_socket_p(int result, bt_adapter_device_discovery_state_e discovery_state,
		bt_adapter_device_discovery_info_s* discovery_info, void* user_data);
void device_bonded_cb_for_socket_p(int result, bt_device_info_s *device_info, void* user_data);
void socket_data_received_cb_for_socket_p(bt_socket_received_data_s *data, void* user_data);
void socket_connection_state_changed_cb_for_socket_p(int result, \
		bt_socket_connection_state_e connection_state, bt_socket_connection_s *connection, void* user_data);
...
static void utc_network_bluetooth_socket_set_connection_state_changed_cb_p(void)
{
	...
	dts_check_eq("bt_socket_set_connection_state_changed_cb", ret, BT_ERROR_NONE, 
...
static void utc_network_bluetooth_socket_connect_rfcomm_p(void)
{
	...
	{
		dts_fail("bt_socket_connect_rfcomm", "bt_socket_connect_rfcomm() failed");
	}
	dts_check_eq("bt_socket_connect_rfcomm", callback_result, true, "connecting failed.");
}
...
static void utc_network_bluetooth_socket_disconnect_rfcomm_p(void)
{
	...
	dts_check_eq("bt_socket_disconnect_rfcomm", ret, BT_ERROR_NONE, "bt_socket_disconnect_rfcomm() failed.");
}
...
static void utc_network_bluetooth_socket_send_data_p(void)
{
	...
	dts_check_eq("bt_socket_send_data", ret, BT_ERROR_NONE, "bt_socket_send_data() failed.");
}
...
static void utc_network_bluetooth_socket_unset_connection_state_changed_cb_p(void)
{
	...
	dts_check_eq("bt_socket_unset_connection_state_changed_cb", ret, BT_ERROR_NONE, 
