...
void adapter_state_changed_cb_for_discovery_n(int result, bt_adapter_state_e adapter_state, void* user_data);
...
static void utc_network_bluetooth_device_discovery_cancel_n(void)
{
	...
	dts_check_eq("bt_adapter_stop_device_discovery", ret, BT_ERROR_NOT_ENABLED, 
...
static void utc_network_bluetooth_device_discovery_unset_state_changed_cb_n(void)
{
	...
	{
		dts_fail("bt_adapter_unset_device_discovery_state_changed_cb", "bt_deinitialize() failed.");
	}
	ret = bt_adapter_unset_device_discovery_state_changed_cb();
	dts_check_eq("bt_adapter_unset_device_discovery_state_changed_cb", ret, BT_ERROR_NOT_INITIALIZED, 
...
static void utc_network_bluetooth_device_discovery_set_state_changed_cb_n(void)
{
	...
	dts_check_eq("bt_adapter_set_device_discovery_state_changed_cb", ret, BT_ERROR_INVALID_PARAMETER, 
...
static void utc_network_bluetooth_device_discovery_start_n(void)
{
	...
	dts_check_eq("bt_adapter_start_device_discovery", ret, BT_ERROR_NOT_ENABLED, 
			"BT_ERROR_NOT_ENABLED must be returned when BT is not enabled");    
}
