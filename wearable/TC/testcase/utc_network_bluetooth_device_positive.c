...
void adapter_state_changed_cb_for_device_p(int result, bt_adapter_state_e adapter_state, void* user_data);
void device_discovery_state_changed_cb_for_device_p(int result, bt_adapter_device_discovery_state_e discovery_state, 
		bt_adapter_device_discovery_info_s* discovery_info, void* user_data);
void device_bonded_cb(int result, bt_device_info_s *device_info, void* user_data);
...
void device_bonded_cb(int result, bt_device_info_s *device_info, void* user_data)
{
	...
	if(result == BT_ERROR_TIMED_OUT)
		...
		tet_printf("result is unknown: %s", _bt_convert_error_to_string(result));
...
static void utc_network_bluetooth_device_set_authorization_state_changed_cb_p(void)
{
	...
	dts_check_eq("bt_device_set_authorization_changed_cb", ret, BT_ERROR_NONE, 
...
static void utc_network_bluetooth_device_cancel_bonding_p(void)
{
	...
	if( bt_device_set_bond_created_cb(device_bonded_cb, "cancel") != BT_ERROR_NONE )
	{
		dts_fail("bt_device_cancel_bonding", "bt_device_set_bond_created_cb() failed");
	}
	...
	if( ret != BT_ERROR_NONE )
	{
		dts_fail("bt_device_cancel_bonding", "bt_device_create_bond failed");
	}
	...
	{       
		...
		dts_check_eq("bt_device_cancel_bonding", callback_result, true, "Failed");
	}
	else
	{
		bt_device_unset_bond_created_cb();        
		dts_fail("bt_device_cancel_bonding", "bt_device_cancel_bonding() failed");
	}    
}
...
static void utc_network_bluetooth_device_bond_p(void)
{
	...
	if( ret != BT_ERROR_NONE )
	{
		dts_fail("bt_device_create_bond", "bt_device_set_bond_created_cb() failed");
	}
	...
	{       
		...
		g_source_remove(timeout_id);
		bt_device_unset_bond_created_cb();
		dts_check_eq("bt_device_create_bond", callback_result, true, "Failed");
	}
	else
	{       
		bt_device_unset_bond_created_cb();
		dts_fail("bt_device_create_bond", "bt_device_create_bond() failed");
	}    
}
...
static void utc_network_bluetooth_device_foreach_bonded_device_p(void)
{
	...
	if (ret == BT_ERROR_NONE ) {
		dts_pass("bt_adapter_foreach_bonded_device", "bt_adapter_foreach_bonded_device pass");
	} else {
		dts_fail("bt_adapter_foreach_bonded_device", "bt_adapter_foreach_bonded_device() failed");
	}
}
...
static void utc_network_bluetooth_device_set_alias_p(void)
{
	...
	dts_check_eq("bt_device_set_alias", ret, BT_ERROR_NONE, "bt_device_set_alias() failed");       
}
...
static void utc_network_bluetooth_device_set_authorization_p(void)
{
	...
	if( ret == BT_ERROR_NONE )
	{
		...
		g_main_loop_run(mainloop);
		g_source_remove(timeout_id);
		dts_check_eq("bt_device_set_authorization", callback_result, true, "Callback was called but failed");
		callback_result = false;
	}
	else
	{
		dts_fail("bt_device_set_authorization", "bt_device_set_authorization() failed");
	}    
}
...
static void utc_network_bluetooth_device_unbond_p(void)
{
	...
	if( ret == BT_ERROR_NONE ) 
	{
		...
		g_main_loop_run(mainloop);	
		g_source_remove(timeout_id);
		dts_check_eq("bt_device_destroy_bond", callback_result, true, "Failed");
	}
	else
	{       
		dts_fail("bt_device_destroy_bond", "bt_device_destroy_bond() failed");
	}    
}
...
static void utc_network_bluetooth_device_unset_authorization_state_changed_cb_p(void)
{
	...
	dts_check_eq("bt_device_unset_authorization_changed_cb", ret, BT_ERROR_NONE, 
