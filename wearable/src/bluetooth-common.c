...
static bt_event_sig_event_slot_s bt_event_slot_container[] = {
	...
	{BT_EVENT_DEVICE_DISCONNECTED, NULL, NULL},
	...
	{BT_EVENT_HF_SCO_CONNECTION_STATUS, NULL, NULL},
	{BT_EVENT_HF_SPEAKER_GAIN_CHANGE, NULL, NULL},
	{BT_EVENT_HF_CALL_HANDLING_EVENT, NULL, NULL},
	{BT_EVENT_HF_VENDOR_DEP_CMD_EVENT, NULL, NULL},
	{BT_EVENT_HF_MULTI_CALL_HANDLING_EVENT, NULL, NULL},
...
static void __bt_event_proxy(int event, bluetooth_event_param_t *param, void *user_data)
{
	...
	case BLUETOOTH_EVENT_DEVICE_DISCONNECTED:
		...
		if (_bt_check_cb(BT_EVENT_DEVICE_DISCONNECTED)) {
			((bt_device_disconnected_cb)bt_event_slot_container[BT_EVENT_DEVICE_DISCONNECTED].callback)
			(device_addr, param->result, bt_event_slot_container[BT_EVENT_DEVICE_DISCONNECTED].user_data);
		}
	...
	case BLUETOOTH_EVENT_HF_RING_INDICATOR:
		...
		char *phone_number = (char *)(param->param_data);
	...
	case BLUETOOTH_EVENT_GATT_CONNECTED:
		...
		(_bt_get_error_code(param->result), bt_event_slot_container[event_index].user_data);
		break;
